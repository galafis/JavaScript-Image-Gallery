...
**Javascript Image Gallery** — Professional JavaScript-Image-Gallery - Created by Gabriel Demetrios Lafis

Total source lines: **113** across **4** files in **3** languages.
...
Total de linhas de código: **113** em **4** arquivos em **3** linguagens.
